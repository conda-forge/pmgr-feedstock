...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pmgr-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12971&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pmgr-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pmgr` can be installed with:

```
conda install pmgr
```

It is possible to list all of the versions of `pmgr` available on your platform with:
